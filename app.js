...
app.use('/', routes);
app.use('/email', email);
app.use('/views/project1', project1);
app.use('/views/project2', project2);
app.use('/views/project3', project3);
app.use('/views/project4', project4);
app.use('/views/project5', project5);
app.use('/views/project6', project6);
